      ...
      <form action="" method="GET">
        ...
        <div class="row">
          ...
          <div class="col-sm-3 col-md-3 col-lg-3">
            ...
            <select name="empreendimento" id="" class="form-control">
...
<div class="content__container">
  <div class="chart__title">
    Leads por consultor de campo
  </div>
  <div id='chart_leads_consultor'></div>
</div>
...
<script>
  ...
  Morris.Bar({
    element: 'chart_leads_consultor',
    data: [
    @foreach ($qtdLeadByConsultor as $qc)
      { user: '{{$qc->name}}', qtd: {{$qc->leads_count}} },
    @endforeach
    ],
    xkey: 'user',
    ykeys: ['qtd'],
