  ...
  <div class="app-container">
    <aside class="app-sidebar">
      ...
      @if(auth()->user())
        ...
        @if(auth()->user()->privilege_id !== 1)
          <li>
            <div class="app-menu__separator">Consultores</div>
          </li>
          <li><a class="app-menu__link {{request()->segment(1) == 'consultor' && request()->segment(2) == '' ?  'app-menu__link--active' : ''}}" title="" href="{{route('consultor')}}"><i class="fas fa-list"></i>Listar</a></li>
          <li><a class="app-menu__link {{request()->segment(1) == 'consultor' && request()->segment(2) == 'add' ?  'app-menu__link--active' : ''}}" title="" href="{{route('consultor.create')}}"><i class="fas fa-user-plus"></i>Cadastrar</a></li>
        @endif

        @if(auth()->user()->privilege_id !== 1)
          <li>
            <div class="app-menu__separator">Empreendimento</div>
          </li>
          <li><a class="app-menu__link {{request()->segment(1) == 'empreendimento' && request()->segment(2) == '' ?  'app-menu__link--active' : ''}}" title="" href="{{route('empreendimento')}}"><i class="fas fa-list"></i>Listar</a></li>
          <li><a class="app-menu__link {{request()->segment(1) == 'empreendimento' && request()->segment(2) == 'add' ?  'app-menu__link--active' : ''}}" title="" href="{{route('empreendimento.create')}}"><i class="fas fa-user-plus"></i>Cadastrar</a></li>
        @endif
    ...
    <main class="app-content">
      ...
      <footer class="app-footer">
        <a title="Desenvolvido por Liv Digital" target="_blank" href="https://livdigital.com.br/">
          Desenvolvido por <img alt="Liv Digital" src="{{ URL::asset('img/liv-digital.png') }}" /> www.livdigital.com.br
        </a>
      </footer>
